...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertiesForSellPageModule", function() { return PropertiesForSellPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__properties_for_sell__ = __webpack_require__(754);
...
var PropertiesForSellPageModule = /** @class */ (function () {
    function PropertiesForSellPageModule() {
    }
    PropertiesForSellPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__properties_for_sell__["a" /* PropertiesForSellPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__properties_for_sell__["a" /* PropertiesForSellPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */]
            ],
        })
    ], PropertiesForSellPageModule);
    return PropertiesForSellPageModule;
}());

//# sourceMappingURL=properties-for-sell.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PropertiesForSellPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
 ...
 */
var PropertiesForSellPage = /** @class */ (function () {
    function PropertiesForSellPage(events, languageService, navCtrl, navParams, storage, poviderForAllProvider, translate, toastController, loadingCtrl, fb, ToastController, modalCtrl) {
        this.events = events;
        ...
        this.minSellList = ['300,000', '450,000', '600,000', '750,000', '900,000', '1,000,000', '1,500,000', '2,000,000', '2,500,000', '3,000,000', '3,500,000', '40,00,000'];
    ...
    PropertiesForSellPage.prototype.ngOnInit = function () {
    ...
    PropertiesForSellPage.prototype.slidePrev = function (i) {
    ...
    PropertiesForSellPage.prototype.slideNext = function (i) {
        console.log("I ==== " + i);
    ...
    PropertiesForSellPage.prototype.CheckMap = function () {
        var _this = this;
        if (this.pet == "albums") {
    ...
    PropertiesForSellPage.prototype.ionViewDidLoad = function () {
        // this.getSellProperty();
        console.log('ionViewDidLoad PropertiesForSellPage');
        // this.initMap();
    };
    PropertiesForSellPage.prototype.getSellProperty = function () {
        var _this = this;
        this.storage.get('user').then(function (val) {
            _this.token = val.token;
            console.log("Token === " + _this.token);
            // this.showLoader();
            _this.poviderForAllProvider.getSellProperty(_this.token, 1).subscribe(function (res) {
    ...
    //  }
    // }
    PropertiesForSellPage.prototype.doInfinite = function (infiniteScroll, getPageNum) {
        var _this = this;
    ...
    PropertiesForSellPage.prototype.showLoader = function () {
    ...
    PropertiesForSellPage.prototype.openPropertyDetail = function (propertyDetails) {
    ...
    ////===========================================
    PropertiesForSellPage.prototype.initMap = function () {
        // FORM DATA======================================================
    ...
    PropertiesForSellPage.prototype.doSomething = function (ev) {
    ...
    // Set fvrt
    PropertiesForSellPage.prototype.favorite = function (property, status) {
        var _this = this;
    ...
    //  end favrt
    // FOR Search result
    PropertiesForSellPage.prototype.sendData = function (value, num) {
        var _this = this;
    ...
    // 
    //GET CITY=======
    PropertiesForSellPage.prototype.getCity = function () {
        var _this = this;
        this.storage.get('user').then(function (val) {
    ...
    PropertiesForSellPage.prototype.loaderPresent = function () {
        this.loading = this.loadingCtrl.create();
        this.loading.present();
    };
    // Show Toast 
    PropertiesForSellPage.prototype.showToast = function (toastMsg) {
    ...
    // SET STUDIO'S====================
    PropertiesForSellPage.prototype.setstudio = function (studio, formVal) {
    ...
    //         });
    //       }
    PropertiesForSellPage.prototype.advanceFilter = function () {
        var _this = this;
        var modal = this.modalCtrl.create('page-property-filter', this.sellForm.value);
        modal.present();
        modal.onDidDismiss(function (data) {
            console.log("ADVANCE FILTER RESPONSE    ==== ", data);
            if (data) {
                console.log("IF CONDITIONss== ");
                _this.sellForm.value.furniture = data.value.furniture;
                _this.sellForm.value.amenities = data.value.amenities;
                _this.sellForm.value.Type = data.value.Type;
                _this.sendData(_this.sellForm.value, '2');
            }
            else {
    ...
    // END 
    PropertiesForSellPage.prototype.setStudioValue = function (val) {
        console.log("Studio ===" + val);
        this.studios = val;
    };
    PropertiesForSellPage.prototype.getUserDetails = function () {
        var _this = this;
    ...
    // Languages
    PropertiesForSellPage.prototype.setLanguage = function () {
        var _this = this;
    ...
    return PropertiesForSellPage;
}());

//# sourceMappingURL=properties-for-sell.js.map
